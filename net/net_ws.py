...
class TestNetNamespaceWS(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestNetNamespaceWS("test_net_version_success"))
        suite.addTest(TestNetNamespaceWS("test_net_networkID_success_wrong_value_param"))
        suite.addTest(TestNetNamespaceWS("test_net_networkID_success"))
        suite.addTest(TestNetNamespaceWS("test_net_listening_success_wrong_value_param"))
        suite.addTest(TestNetNamespaceWS("test_net_listening_success"))
        suite.addTest(TestNetNamespaceWS("test_net_peerCount_success_wrong_value_param"))
        suite.addTest(TestNetNamespaceWS("test_net_peerCount_success"))
        suite.addTest(TestNetNamespaceWS("test_net_peerCountByType_success"))
