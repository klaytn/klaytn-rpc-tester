...
class TestKlayNamespaceFilterRPC(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_newFilter_error_no_param"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_newFilter_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_newFilter_success"))
        ...
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_newPendingTransactionFilter_success"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_uninstallFilter_error_no_param"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_uninstallFilter_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_uninstallFilter_success_false"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_uninstallFilter_success"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_getFilterChanges_error_no_param"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_getFilterChanges_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_getFilterChanges_error_wrong_value_param"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_getFilterChanges_success"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_getFilterLogs_error_no_param"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_getFilterLogs_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_getFilterLogs_error_wrong_value_param"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_getFilterLogs_success"))
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_getLogs_error_no_param"))
        ...
        suite.addTest(TestKlayNamespaceFilterRPC("test_klay_getLogs_success"))
        """ 
        suite.addTest(
            TestKlayNamespaceFilterRPC("test_klay_subscribe_success")
        )
        """
        return suite
