...
class TestKlayNamespaceMiscellaneousWS(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromTransaction_error_no_param"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromTransaction_error_wrong_type_param1"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromTransaction_error_wrong_type_param2"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromTransaction_error_wrong_value_param1"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromTransaction_error_wrong_value_param2"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromTransaction_success"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromMessage_error_no_param"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromMessage_error_wrong_type_param1"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromMessage_error_wrong_type_param2"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromMessage_error_wrong_value_param1"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromMessage_error_wrong_value_param2"))
        suite.addTest(TestKlayNamespaceMiscellaneousWS("test_klay_recoverFromMessage_success"))
