...
class TestKlayNamespaceBlockWS(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_syncing_success_wrong_value_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_syncing_success"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_blockNumber_success"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_blockNumber_success_wrong_value_param"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getStorageAt_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getStorageAt_error_wrong_type_param1"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getStorageAt_error_wrong_type_param2"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getStorageAt_success_wrong_value_param"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getStorageAt_success"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockTransactionCountByHash_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockTransactionCountByHash_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockTransactionCountByHash_error_wrong_value_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockTransactionCountByHash_success"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockTransactionCountByNumber_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockTransactionCountByNumber_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockTransactionCountByNumber_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockTransactionCountByNumber_error_wrong_value_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockTransactionCountByNumber_success"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByHash_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByHash_error_wrong_type_param1"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByHash_error_wrong_type_param2"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByHash_error_wrong_value_param"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByHash_success"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByNumber_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByNumber_error_wrong_type_param1"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByNumber_error_wrong_type_param2"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByNumber_error_wrong_value_param1"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByNumber_error_wrong_value_param2"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockByNumber_success"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockReceipts_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockReceipts_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockReceipts_fail_wrong_value_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockReceipts_success"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getHeaderByHash_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getHeaderByHash_error_wrong_type_param1"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getHeaderByHash_error_wrong_value_param"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getHeaderByHash_success"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getHeaderByNumber_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getHeaderByNumber_error_wrong_type_param1"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getHeaderByNumber_error_wrong_value_param1"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getHeaderByNumber_error_wrong_value_param2"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getHeaderByNumber_success"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockWithConsensusInfoByHash_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockWithConsensusInfoByHash_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockWithConsensusInfoByHash_error_wrong_value_param"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockWithConsensusInfoByHash_success"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockWithConsensusInfoByNumber_error_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockWithConsensusInfoByNumber_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockWithConsensusInfoByNumber_error_wrong_value_param"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getBlockWithConsensusInfoByNumber_success"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCommittee_success_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCommittee_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCommittee_error_wrong_value_param"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCommittee_success"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCommitteeSize_success_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCommitteeSize_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCommitteeSize_error_wrong_value_param"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCommitteeSize_success"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCouncil_success_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCouncil_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCouncil_error_wrong_value_param"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCouncil_success"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCouncilSize_success_no_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCouncilSize_error_wrong_type_param"))
        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCouncilSize_error_wrong_value_param"))

        suite.addTest(TestKlayNamespaceBlockWS("test_klay_getCouncilSize_success"))
