...
class TestEthNamespaceMiscellaneousWS(unittest.TestCase):
    ...
    def suite():
        ...
        suite.addTest(TestEthNamespaceMiscellaneousWS("test_eth_hashrate_success"))
        suite.addTest(TestEthNamespaceMiscellaneousWS("test_eth_mining_success"))
        suite.addTest(TestEthNamespaceMiscellaneousWS("test_eth_submitWork_error_wrong_type_param1"))
        suite.addTest(TestEthNamespaceMiscellaneousWS("test_eth_submitWork_error_wrong_type_param2"))
        suite.addTest(TestEthNamespaceMiscellaneousWS("test_eth_submitWork_error_wrong_type_param3"))
        suite.addTest(TestEthNamespaceMiscellaneousWS("test_eth_submitHashrate_error_wrong_type_param1"))
        suite.addTest(TestEthNamespaceMiscellaneousWS("test_eth_submitHashrate_error_wrong_type_param2"))
        suite.addTest(TestEthNamespaceMiscellaneousWS("test_eth_submitHashrate_success"))
        suite.addTest(TestEthNamespaceMiscellaneousWS("test_eth_getHashrate_success"))
